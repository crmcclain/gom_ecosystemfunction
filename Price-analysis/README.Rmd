---
title: Deep-sea BEF price analysis
output: github_document
---

This project contains the script to perform all Price analyses on woodfall communities.
...
3) performing data transformations on price components to relative importance, relative contribution, and normalized scales for analysis and summary
...
4) loads generalized additive models (GAMs) (all code to rerun is found in `run-GAM-script.R`)
